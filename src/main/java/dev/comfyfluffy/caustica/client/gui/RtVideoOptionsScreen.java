 ...
 * Clouds, Fog &amp; God Rays, Exposure, Tonemapping, HDR, Terrain Streaming, Debug and the
 * experimental SHaRC page — each opened by one of the buttons below (see {@link RtSubScreens} for
 * the factories).
 *
